...
class Token:
    ...
    def get_token(self):
        service_account_id = config.translator.service_account_id
        key_id = config.translator.key_id  # ID ресурса Key, который принадлежит сервисному аккаунту.
        with open("utils/translator/newkey.json", 'r') as private:
